...
module.exports = function(Chart) {
	...
	Chart.Scale = Chart.Element.extend({
        ...
        /* ===== motify area start by samsung ====== */
        var tmpFontColor = 	context.fillStyle;
        if (Object.prototype.toString.call( tickFontColor ) === '[object Array]') {
          tmpFontColor = tickFontColor[index];
        } else {
          tmpFontColor = tickFontColor;
        }
        /* ===== motify area end by samsung ====== */
				...
				itemsToDraw.push({
					...
					textAlign: textAlign,
          tickFontColor: tmpFontColor, // modify by samsung
				});
			});
			...
			helpers.each(itemsToDraw, function(itemToDraw) {
				...
				if (optionTicks.display) {
					...
					/* ===== modify area start by samsung====== */
					if(itemToDraw.tickFontColor=="#505050") {
						context.fillStyle = "#3695DD";
						context.fillRect(-12, -7, 24, 2);
						var tmpFontStyle = optionTicks.fontStyle;
						optionTicks.fontStyle = "bold";
						var tmpTickFont = parseFontOptions(optionTicks);
						context.font = tmpTickFont.font;
						optionTicks.fontStyle = tmpFontStyle;
					}
					if(itemToDraw.tickFontColor=="#505051") {
						var tmpFontStyle = optionTicks.fontStyle;
						optionTicks.fontStyle = "bold";
						var tmpTickFont = parseFontOptions(optionTicks);
						context.font = tmpTickFont.font;
					...
					context.fillStyle = itemToDraw.tickFontColor;
					/* ===== modify area end by samsung====== */
