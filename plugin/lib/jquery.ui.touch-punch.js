...
/*
 * add support for long press solution.
 * https://github.com/furf/jquery-ui-touch-punch/pull/290/files
*/
...
(function ($) {
  ...
  mouseProto._touchStart = function (event) {
    ...
    $('#edit_page_sortableDiv').on('touchcancel', (e) => {
      e.stopPropagation();
      self._touchEnd(event);
    });

    if(window.touchPunchDelay === -1){
      // console.log("skip touchStart");
      return;
    }
  ...
  mouseProto._touchMove = function (event) {
    ...
    if(this._touchMoved==false) {
      clearEditPageBar();

    /*      console.log(this.currentItem[0].id);
      var sortablenum = this.currentItem[0].id.substring(22);
      console.log(sortablenum);
      $("#edit_page_bar_"+sortablenum).css("visibility","hidden"); */
    }
